...
export default function FlightsPage() {
  ...
  // Interactive Variables mapping to the outer queries of MVs
  ...
  return (
    <Container style={{ paddingTop: '40px' }}>
      <Typography variant="h3" gutterBottom>Deep Dive: Advanced Travel Analytics</Typography>
      <p>Fine-tune the parameters below to filter pre-computed geospatial combinations instantly.</p>
      ...
      <Grid container spacing={2} style={{ marginBottom: '30px' }}>
        <Grid item><Button variant={activeQuery === 'stranded' ? 'contained' : 'outlined'} onClick={() => runQuery('stranded')}>Problematic Airports</Button></Grid>
        <Grid item><Button variant={activeQuery === 'regional' ? 'contained' : 'outlined'} onClick={() => runQuery('regional')}>Reliable States & Coffee</Button></Grid>
        <Grid item><Button variant={activeQuery === 'nohotels' ? 'contained' : 'outlined'} onClick={() => runQuery('nohotels')}>Nearby Lodgings</Button></Grid>
        <Grid item><Button variant={activeQuery === 'restaurants' ? 'contained' : 'outlined'} onClick={() => runQuery('restaurants')}>Evening Delays</Button></Grid>
      </Grid>
